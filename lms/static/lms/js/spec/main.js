...
(function(requirejs) {
    ...
    requirejs.config({
        ...
        paths: {
            ...
            jquery: 'node_copies/js/jquery',
            'jquery-migrate': 'node_copies/js/jquery-migrate',
            ...
            'jquery.scrollTo': 'node_copies/js/jquery.scrollTo',
            ...
            moment: 'node_copies/js/moment-with-locales',
            'moment-timezone': 'node_copies/js/moment-timezone-with-data',
            'text': 'xmodule_js/common_static/js/vendor/requirejs/text',
            'underscore': 'node_copies/js/underscore',
            'underscore.string': 'node_copies/js/underscore.string',
            'backbone': 'node_copies/js/backbone',
            'backbone.associations': 'xmodule_js/common_static/js/vendor/backbone-associations-min',
            'backbone.paginator': 'node_copies/js/backbone.paginator',
            ...
            'sinon': 'node_copies/js/sinon',
            'squire': 'node_copies/js/Squire',
            ...
            'picturefill': 'node_copies/js/picturefill',
            'bootstrap': 'node_copies/js/bootstrap.bundle',
